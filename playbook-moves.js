const allPlaybookMoves = {
    ...
    blessed: {
        ...
        amuletsAndTalismans: `<div class='move-card'><h3>Amulets & Talismans</h3><p>When you <b><i>craft a protective charm for someone</i></b>, spend 1 Stock and name a source of harm (fire, stabbing, etc.). When they <b><i>would suffer such harm while bearing your charm</i></b>, roll +INT: <b>on a 10+</b>, they ignore the harm entirely; <b>on a 7-9</b>, they suffer only half the damage or effect; <b>on a 6-</b>, they suffer the harm normally. One can benefit from only 1 charm at a time, and it loses its potency after 1 use.</p></div>`,
        ...
        bigMagic: `<input type="checkbox"><input type="checkbox"><h3>Big Magic</h3><p>Each time you take this move, choose an additional remarkable trait for your sacred pouch and increase your max Stock by 2.</p>`,
        ...
        improvedStat: `<input type="checkbox"><input type="checkbox"><input type="checkbox"><h3>Improved Stat</h3><p>Each time you take this move, increase one of your stats by 1 (to a max of +2).</p>`,
        ...
        ritesOfTheLand: `<div class="move-card"><h3>Rites of the Land</h3><p>When <b><i>Seasons Change and you oversee the sacred rites</i></b>, you can sacrifice 2 Surplus to increase the steading’s Fortunes by 1 (max +3). If you sacrifice something (or someone) much-loved and greatly valued, you can redo a roll from Seasons Change, with your choice of advantage or disdvantage.</p></div>`,

        spiritTongue: `<div class="move-card"><h3>Spirit Tongue</h3><p>You can speak with natural beasts and spirits of the wild. You can always ask the GM “what spirits are active here?” and get an honest answer.</p></div>`,

        borrowPower: `<h3>Borrow Power</h3><p style="text-align: center;">(Requires Spirit Tongue)</p><p>When <b><i>a spirit or beast loans you power</i></b>, ask the GM for one of its moves. Store it in your sacred pouch in place of 1 Stock. When you <b><i>use the borrowed move</i></b>, roll +WIS: <b>on a 10+</b>, you do it and can use the move again; <b>on a 7-9</b>, you do it, but lose the move.</p>`,

        callTheSpirits: `<div class="move-card"><h3>Call the Spirits</h3><p style="text-align: center;">(Requires Spirit Tongue)</p><p>When you <b><i>perform a short ritual and invoke the spirit(s) of a place or object</i></b>, spend 1 Stock. The spirit(s) manifest before you and will hear what you have to say. What they do next is up to them.</p></div>`,
        ...
        wildSoul: `<input type="checkbox"><input type="checkbox"><h3>Wild Soul</h3><p>Each time you take this move, gain a Ranger move of your choice for which you qualify. You can’t pick Improved Stat or Superior Stat.</p>`,

        naturesWrath: `<h3>Nature's Wrath</h3><p style="text-align: center;">(Requires level 6+ and Danu’s Grasp)</p><p>Danu’s Grasp gains the area tag and can affect any creature. A mortal reduced to 0 HP is subdued or killed (your choice) rather than bound in stone.</p>`,

        potentWorkings: `<h3>Potent Workings</h3><p style="text-align: center;">(Requires level 6+ and Amulets & Talismans)</p><p>When you <b><i>craft a protective charm</i></b>, you may spend 1 additional Stock to choose 1:</p><ul><li>Name an additional type of harm</li><li>On a 10+, the charm retains its potency</li></ul>`,

        sharedSouls: `<h3>Shared Souls</h3><p style="text-align: center;">(Requires level 6+ and Into the Lion's Den)</p><p>When you <b><i>mark a beast with 1 Stock</i></b>, you can perceive the world through its senses no matter the distance between you. You can also guide its actions; treat it as a follower with Loyalty +1. Only one such beast can be affected at a time.</p>`,

        suckThePoisonOut: `<h3>Suck the Poison Out</h3><p style="text-align: center;">(Requires level 6+ and Healer's Arts)</p><p>When you <b><i>draw a malady from a patient’s body, mind, or soul</i></b>, spend 1 Stock and roll +WIS: <b>on a 10+</b>, you remove the malady and can safely discard it or store it in your sacred pouch (taking the space of 1 Stock) to study or inflict on another; <b>on a 7-9</b>, you remove it, but choose 1:</p><ul><li>Your patient suffers lingering harm or trauma</li><li>You suffer some of the malady’s effects</li><li>It will be harmful and dangerous to discard</li></ul>`,

        superiorStat: `<h3>Superior Stat</h3><p style="text-align: center;">(Requires level 6+)</p><p>Increase one of your stats by +1 (to a max of +3).</p>`,

        voiceOfTheEarthMother: `<h3>Voice of the Earth Mother</h3><p style="text-align: center;">(Requires level 6+ and Spirit Tongue)</p><p>When you <b><i>speak on behalf of Danu</i></b>, natural beasts and spirits of the wild respect your authority. All but the most headstrong will do as you command, even against their instincts.</p>`
